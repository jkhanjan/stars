...
void main() {
    ...
    // Soft circular falloff for a realistic glow
    ...
    vec3 baseColor = mix(vec3(0.8, 0.8, 1.0), vColor, 0.1); // Slight blue tint for realism
    vec3 starColor = baseColor * brightness;
